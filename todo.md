...
Verified for this fix: 196/196 Opus library tests, 16 active Ogg integration tests, all range tests, strict Clippy, and rustfmt pass. Remaining Opus encoder work is scope expansion (hybrid SILK/CELT, psychoacoustics, stereo coupling, pre-skip), not the former CBR correctness blocker.
